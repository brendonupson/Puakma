...
public class HTTPLogEntry
{
  ...
  private ArrayList m_arrInboundHeaders=new ArrayList();
  private ArrayList m_arrOutboundHeaders=new ArrayList();
  ...
  public HTTPLogEntry(ArrayList alMimeExcludes, ArrayList alInboundHeaders, ArrayList alOutboundHeaders, String szHTTPRequest, String szContentType, long lSize, long lInboundSize, int iReturnCode, String szClientIPAddress, String szClientHostName, String szSystemHostName, String szRequestedHost, long lTrans, String sServerIPAddress, int iPort, SessionContext sess)
  {
    ...
    m_iPort=iPort;
    ArrayList arr = puakma.util.Util.splitString(m_sHTTPRequest, ' ');
    if(arr!=null)
    {
  ...
  */
  private boolean shouldExclude(ArrayList alMimeExcludes)
  {
    int i;
    String sMimeExclude;
