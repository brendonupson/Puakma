...
{    
	...
	private class X500NamePart{
		...
		public ArrayList<String> Values; //eg "Brendon Upson", "Users", ...
	};//inner class
	...
	private ArrayList<X500NamePart> m_NameParts = new ArrayList<X500NamePart>();
	...
	public void put(String sItem, String sText)
	{
		...
		if(nmPart==null) 
		{
			...
			nmPart.Values = new ArrayList<String>();
			nmPart.Key = sItem;
		}
	...
	public String get(String sItem, boolean bRawValue)
	{
		...
		ArrayList<String> arr = nmPart.Values;
